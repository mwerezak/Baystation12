...
/obj/machinery/atmospherics/valve/regulator
	name = "programmable valve"
	desc = "A digitally controlled valve capable of automatically opening and closing at specified pressures."
...
/obj/machinery/atmospherics/valve/regulator/proc/can_read_pressure()
	return (node1 && istype(node1, obj/machinery/atmospherics/pipe))

//Unsafe. Check with can_read_pressure() first.
/obj/machinery/atmospherics/valve/regulator/proc/read_pressure()
	var/obj/machinery/atmospherics/pipe/P = node1

	return node1.return_air().return_pressure()
